...
```bash
workflow-step-function$ sam build
```
...
```bash
workflow-step-function$ sam logs -n StockCheckerFunction --stack-name workflow-step-function --tail
```
...
```bash
workflow-step-function$ cd functions/stock-checker
...
```bash
sam delete --stack-name workflow-step-function
```
